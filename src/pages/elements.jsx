				...
				<div className="container">
					<div className="row d-flex align-items-center justify-content-center">
						<div className="about-content col-lg-12">
							...
							<p className="text-white link-nav"><a href="/">Home </a>  <span className="lnr lnr-arrow-right"></span>  <a href="/elements"> Elements</a></p>
						</div>
					</div>
				</div>
			</section>
				...
				<div className="container">
					...
					<div className="section-top-border">
						...
						<div className="row gallery-item">
							<div className="col-md-4">
								<a href="img/elements/g1.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(img/elements/g1.jpg)' }}></div></a>
							</div>
							<div className="col-md-4">
								<a href="img/elements/g2.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(img/elements/g2.jpg)' }}></div></a>
							</div>
							<div className="col-md-4">
								<a href="img/elements/g3.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(img/elements/g3.jpg)' }}></div></a>
							</div>
							<div className="col-md-6">
								<a href="img/elements/g4.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(img/elements/g4.jpg)' }}></div></a>
							</div>
							<div className="col-md-6">
								<a href="img/elements/g5.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(img/elements/g5.jpg)' }}></div></a>
							</div>
							<div className="col-md-4">
								<a href="img/elements/g6.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(img/elements/g6.jpg)' }}></div></a>
							</div>
							<div className="col-md-4">
								<a href="img/elements/g7.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(img/elements/g7.jpg)' }}></div></a>
							</div>
							<div className="col-md-4">
								<a href="img/elements/g8.jpg" className="img-gal"><div className="single-gallery-image" style={{ background: 'url(img/elements/g8.jpg)' }}></div></a>
							</div>
						</div>
					</div>
					<div className="section-top-border">
